        ...
        >
          ...
          <div className="relative z-10 px-8 lg:px-16 py-16 lg:py-24">
            ...
            <h2 className="text-6xl md:text-7xl lg:text-[72px] font-display tracking-tight mb-8 leading-[0.95]">
              Together, we
              <br />
              <span className="text-[#86efac]">nurture the future.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <Button
                size="lg"
                className="bg-[#86efac] hover:bg-[#86efac]/90 text-black font-bold px-10 h-14 text-base rounded-full group shadow-[0_0_20px_rgba(134,239,172,0.3)]"
              >
                Launch App
            ...
            <p className="text-sm text-muted-foreground mt-8 font-mono italic">
              * Open access for community health workers & public NGOs
            </p>
              </div>
