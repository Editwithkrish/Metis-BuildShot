...
const integrations = [
  { name: "WHO", category: "Global" },
  { name: "UNICEF", category: "Global" },
  { name: "MOHFW", category: "National" },
  { name: "POSHAN", category: "National" },
  { name: "NFHS", category: "Research" },
  { name: "ICMR", category: "Research" },
  { name: "World Bank", category: "Impact" },
  { name: "Bill & Melinda Gates", category: "Impact" },
  { name: "GAVI", category: "Vaccine" },
  { name: "NGO Partners", category: "Local" },
  { name: "Rural Clinics", category: "Local" },
  { name: "Med Colleges", category: "Academic" },
];
