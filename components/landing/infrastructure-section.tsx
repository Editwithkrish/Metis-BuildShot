...
const regions = [
  { name: "Data Centers", nodes: 12, status: "encrypted" },
  { name: "Health Services", nodes: 8, status: "integrated" },
  { name: "API Servers", nodes: 6, status: "operational" },
  { name: "Backup Systems", nodes: 3, status: "redundant" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                HIPAA-compliant infrastructure with end-to-end encryption. Your health data is protected with government-grade security standards.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[10rem] font-display leading-none">99.99%</span>
                <span className="text-2xl text-muted-foreground">uptime SLA</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                24/7 monitoring with redundant systems ensuring continuous health tracking for mothers and newborns.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">HIPAA</span>
              <span className="block text-sm text-muted-foreground mt-2">Compliant</span>
            </div>
            
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-5xl lg:text-6xl font-display">256-bit</span>
              <span className="block text-sm text-muted-foreground mt-2">Encryption</span>
            </div>
          </div>
        </div>
