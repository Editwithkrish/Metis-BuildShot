...
const testimonials = [
  {
    quote: "METIS helped us detect malnutrition in our community early. The personalized nutrition guidance reached families in rural areas via SMS.",
    author: "Priya Sharma",
    role: "Community Health Worker",
    company: "Anganwadi Center",
    metric: { value: "156", label: "Children monitored" },
  },
  {
    quote: "The AI cry detection feature gave us real insights into our newborn's health patterns. The app's multilingual support was crucial for my family.",
    author: "Rajesh Patel",
    role: "New Parent",
    company: "Mumbai Family",
    metric: { value: "24/7", label: "Health tracking" },
  },
  {
    quote: "Our clinic now uses METIS to identify at-risk mothers. The real-time alerts help us intervene before complications occur.",
    author: "Dr. Anjali Gupta",
    role: "Pediatrician",
    company: "Metro Health Center",
    metric: { value: "40%", label: "Earlier interventions" },
  },
  {
    quote: "Integration with government nutrition schemes made it easy for families to access support. This platform truly bridges gaps in healthcare access.",
    author: "Anil Kumar",
    role: "NGO Director",
    company: "Health for All Foundation",
    metric: { value: "850+", label: "Families supported" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Trusted by families
              <span className="text-background/40"> & caregivers.</span>
            </h2>
          </div>
